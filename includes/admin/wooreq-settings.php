...
return apply_filters( 'wc_wooreq_settings',
	array(
		...
		'eth_payment_address' => array(
			...
			'default'     => __( '0x0000000000000000000000000000000000000000', 'woocommerce-gateway-wooreq' ),
			'desc_tip'    => true,
		),
		...
		'accepted_currencies' => array(
			...
			'type'        => 'multiselect',
	        'options'     => WooReq_Helper::get_accepted_currencies(),
		...
		'testmode' => array(
			...
			'type'        => 'checkbox',
			'description' => __( 'Test the plugin on the Rinkeby Network without using real ETH. Please note, ERC20 payments are disabled in this mode.', 'woocommerce-gateway-wooreq' ),
			'default'     => 'no',
			'desc_tip'    => true,
		),
		'logging' => array(
